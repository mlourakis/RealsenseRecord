...
Alternatively, you can create a symbolic link into the ROS workspace
```
...
```
By default, ``/clock`` is also published in this case. To disable it, see the launch parameter ``publish_clock``.
